...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("PUT /api/v1/policies/active", s.handleUpdateFirewallConfig)
	s.mux.HandleFunc("GET /api/v1/policies", s.handleListFirewallConfigs)
	s.mux.HandleFunc("POST /api/v1/policies", s.handleCreateFirewallConfig)
	s.mux.HandleFunc("GET /api/v1/policies/{id}", s.handleGetFirewallConfig)
	s.mux.HandleFunc("PUT /api/v1/policies/{id}", s.handleUpdateFirewallConfigByID)
	s.mux.HandleFunc("DELETE /api/v1/policies/{id}", s.handleDeleteFirewallConfig)
	s.mux.HandleFunc("POST /api/v1/policies/{id}/apply", s.handleApplyFirewallConfig)
